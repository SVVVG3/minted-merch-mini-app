        ...
        headers: [
          ...
          // Note: Relaxed for Shopify, Farcaster, wallet connectors, and inline styles
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.shopify.com https://*.farcaster.xyz https://farcaster.xyz https://*.neynar.com https://api.neynar.com https://*.walletconnect.org https://*.walletconnect.com https://*.web3modal.com https://*.web3modal.org https://*.alchemy.com https://*.infura.io https://*.base.org https://mainnet.base.org https://*.coinbase.com https://cca-lite.coinbase.com https://*.optimism.io https://mainnet.optimism.io https://*.googleapis.com https://api.dexscreener.com https://api.zapper.xyz https://imagedelivery.net https://wrpcd.net https://*.wrpcd.net https://pay-api.daimo.xyz https://*.daimo.xyz https://eth.merkle.io https://*.thirdweb.com https://*.ipfscdn.io https://onchat.sebayaki.com wss://*.alchemy.com wss://*.infura.io wss://*.walletconnect.com wss://*.walletconnect.org",
